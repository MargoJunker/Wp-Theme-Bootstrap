...
$income_section_reason_1_title   = get_field('income_section_reason_1_title');
$income_section_reason_1_description   = get_field('income_section_reason_1_description');
$income_section_reason_2_title   = get_field('income_section_reason_2_title');
$income_section_reason_2_description   = get_field('income_section_reason_2_description');
        ...
        <div class="container clearfix">
            <div class="row">
                ...
                <div class="col-sm-5 hero-text">
                    ...
                    <p>
                        <a class="btn btn-lg btn-danger" role="button" href="<?php echo $course_url; ?>"><?php echo $button_text; ?></a>
                    </p>
                </div><!-- col -->
            </div><!-- row -->
        </div><!-- container -->
...
<section id="boost-income">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h3><?php echo $income_section_reason_1_title ?></h3>
                <p><?php echo $income_section_reason_1_description ?></p>
            </div><!-- col -->
            <div class="col-sm-6">
                <h3><?php echo $income_section_reason_2_title ?></h3>
                <p><?php echo $income_section_reason_2_description ?></p>
            </div><!-- col -->
        </div><!-- row -->
    </div><!-- container -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <p>If you&rsquo;re a designer, learning to code your own WordPress websites can change your business entirely! Now, not only are you a great designer, but you’re a skillful developer, too! This puts you in a position to <strong>make an extra 01,000 – 05,000 per project</strong>.</p>
                <h3>Entrepreneurs</h3>
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="row testimonial">
                    ...
                    <div class="col-sm-8">
                        <blockquote>These videos are well created, concise, fast-paced, easy to follow, and just funny enough to keep you chuckling as you&rsquo;re slamming out lines of code. I&rsquo;ve taken 3 courses from this instructor. Whenever I have questions he is right there with a simple solution or a helpful suggestion to keep me going forward with the course work. <cite>&mdash; Brennan, graduate of all of Brad&rsquo;s courses</cite></blockquote>
                    </div><!-- col -->
                </div><!-- row -->
                <!-- TESTIMONIAL -->
                <div class="row testimonial">
                    ...
                    <div class="col-sm-8">
                        <blockquote>I found Brad to be a great teacher, and a very inspiring person. It&rsquo;s clear he is very passionate about helping designers lear to code, and I look forward to more courses from him! <cite>&mdash; Ben, graduate of Build a Website from Scratch with HTML &amp; CSS</cite></blockquote>
                    </div><!-- col -->
                </div><!-- row -->
                <!-- TESTIMONIAL -->
                <div class="row testimonial">
                    ...
                    <div class="col-sm-8">
                        <blockquote>Brad is amazing and I honestly think he&rsquo;s the best tutor of all the courses I have taken on Udemy. Will definitely be following him in the future. Thanks Brad! <cite>&mdash; AJ, graduate of Code a Responsive Website with Bootstrap 3</cite></blockquote>
                    </div><!-- col -->
                </div><!-- row -->
                <!-- TESTIMONIAL -->
                <div class="row testimonial">
                    ...
                    <div class="col-sm-8">
                        <blockquote>Brad is an excellent instructor. His content is super high quality, and you can see the love and care put into every section. The tutorials are the perfect length, and you feel like you&rsquo;re doing something right of the the gate! I really can&rsquo;t believe this is free. I highly recommend taking advantage of this course. <cite>&mdash; Ernest, graduate of Code Dynamic Websites with PHP</cite></blockquote>
                    </div><!-- col -->
                </div><!-- row -->
            </div><!-- col -->
        </div><!-- row -->
