        ...
        <div class="container clearfix">
            <div class="row">
                ...
                <div class="col-sm-5 hero-text">
                    ...
                    <p class="lead">Earn An Extra 01k - 05k a Month by Learning to Code Your Very Own Responsive &amp; Custom WordPress Websites with Bootstrap</p>
                    ...
                    <p>
                        <a class="btn btn-lg btn-danger" role="button" href="/">Enroll &raquo;</a>
                    </p>
                </div><!-- col -->
            </div><!-- row -->
        </div><!-- container -->
